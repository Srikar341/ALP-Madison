...
# Why are lines7, 9 and 11 indented?
  # Answer Because they are attatached to the if, elif, and else statments before them

# What is the purpose of this program?
  # Answer To show how to create a code with multiple conditions and answers